...
import static greeting.service.GreetingServerTls.PORT;
...
public class GreetingClientTls {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        var creds = TlsChannelCredentials.newBuilder().trustManager(
                new File("ssl/ca.crt")
        ).build();

        ManagedChannel channel = Grpc.newChannelBuilderForAddress("localhost", PORT, creds).build();
